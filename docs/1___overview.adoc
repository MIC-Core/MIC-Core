...
The development of MIC Core was prompted by the Model Identity Card (MIC) ( + + + REFERENCE TO THE STANDARD + + + ) and other metadata standards and the realization that certain core attributes should be standardized across the different metadata standards. 
