...
=== Mapping of MIC Core attributes to the LOTAR standard
...
| Release | baselineProductID | Unique identifier, preferably human-readable (i.e. semantically meaningful), for the release of a particular simulation model.
